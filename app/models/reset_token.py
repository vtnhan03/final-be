...
class ResetToken(Base):
    ...
    token = Column(String(255), unique=True, index=True)  # Long token for URL-based reset
    verification_code = Column(String(10), index=True)  # Short code for form-based reset
